...
impl ToneRef {
    ...
    pub fn bank(&self) -> Option<&'static str> {
        match (self.tone_type(), self.address.lsb) {
            ...
            // Panel-confirmed on a FANTOM-6: `Artists' Choice`, its first tone, lists under EXSN04.
            (ToneType::Exsn, 67) => Some("EXSN04"),
            ...
            (ToneType::Model, 0) => Some("USER"),
            // Panel-confirmed on a FANTOM-6, bank by bank, against a SysEx sweep of each. An
            // earlier reading of one export had every label one slot late and the last two
            // swapped, and called 64 `USER` — see `docs/FORMAT.md`.
            (ToneType::Model, 64) => Some("JP8"),
            (ToneType::Model, 66) => Some("JU106"),
            (ToneType::Model, 68) => Some("JX8P"),
            (ToneType::Model, 70) => Some("SH101"),
            (ToneType::Model, 72) => Some("JD800"),
            (ToneType::Model, 79) => Some("n/zyme"),
...
mod tests {
    ...
    fn classifies_documented_engine_and_bank_addresses() {
        let cases = [
            ...
            (97, 0, ToneType::Model, Some("USER")),
            (97, 64, ToneType::Model, Some("JP8")),
            (97, 66, ToneType::Model, Some("JU106")),
            (97, 72, ToneType::Model, Some("JD800")),
            (97, 79, ToneType::Model, Some("n/zyme")),
            (105, 67, ToneType::Exsn, Some("EXSN04")),
